...
// 잠재력 돌파 확률표 (%), 인덱스 i = (i)->(i+1) 단계. 실제 비용 계산은 아래 ANCIENT_ANVIL.equip
// (고대의 모루 확정 성공 시도 횟수)를 사용합니다 — 이 원본 확률표는 참고·출처 확인용입니다.
...
// 장비 돌파 7→8("칠흑같은 혼돈의 장비"), 8→9("피어나는 그림자 장비")는 실패 시 확률적으로
// 1단계 하락할 수 있는 위험 구간입니다. "그냥 강화"는 실패당 돌파 복구권 200개+은화 500으로
// 50% 확률로 하락을 막고, "혼돈의 그림자 장비"(실패당 돌파 복구권 1050개+은화 5000으로 제작하는
// 소모품)를 쓰면 100% 막을 수 있습니다(사용자 제공값).
export const RISKY_STEPS = {
  7: { label: "칠흑같은 혼돈의 장비", plainTicket: 200, plainSilver: 500, shadowTicket: 1050, shadowSilver: 5000 },
  8: { label: "피어나는 그림자 장비", plainTicket: 200, plainSilver: 500, shadowTicket: 1050, shadowSilver: 5000 }
};
