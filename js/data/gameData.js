...
// 7=34, 8=50, 9=100. 실패 시 복구는 0~6강(대상 1~7강)까지는 결정화된 토템으로, 7·8강(대상
// 8·9강)은 각각 피어나는·구원하는 오기에르의 가호 1개로 100% 복구합니다(둘 다 오기에르의
// 가호 3개/10개로 제작하는 완제품이라 계산은 완제품 시세로 단순화). 9→10강 복구는 공개된
// 자료가 없어 직접 입력을 유지합니다. 매 시도(성공/실패 모두) 소모량은 정보가 없어 결정화된
// 토템 1개(더미)로 가정합니다. 사용자 제공값, 2026-07-30 확인.
...
export const RIFT_TOTEM_RECOVERY_MATERIAL = [
  ...
  "피어나는 오기에르의 가호", "구원하는 오기에르의 가호", undefined
];
export const RIFT_TOTEM_RECOVERY_QTY = [1, 2, 4, 9, 43, 240, 3700, 1, 1, undefined];
...
export const RECOVERY_NOTES = {
  ...
  riftTotem: "실패 시 0~6강은 결정화된 토템으로, 7·8강은 각각 피어나는·구원하는 오기에르의 가호 1개로 100% 복구됩니다(사용자 제공값). 9→10강 복구는 공개된 자료가 없어 직접 입력이 필요합니다."
};
