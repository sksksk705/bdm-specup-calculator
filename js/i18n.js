...
const EXACT = {
  ...
  "순도 높은 흑결정": "High-Purity Black Crystal", "고결한 흑결정(그림자 장비용)": "Noble Black Crystal (for Shadow Gear)",
  ...
  "가문 전투력": "Family CP", "장신구/기타": "Accessory/Other", "복구 재화": "Recovery Material", "문양 각인서": "Crest Book",
  ...
  // ── 재료명 ──
  "아크라드": "Ah'krad", "혼돈의 축": "Chaos Core", "공허의 눈": "Voidsent Eye", "혼돈의 핵": "Chaos Nucleus",
  "홍익의 불꽃": "Flame of Benevolence", "홍익의 불씨": "Ember of Benevolence",
  "차원의 조각": "Dimensional Fragment", "균열의 열기": "Rift's Heat", "공허의 주술핵": "Voidsent Shaman's Core",
  "투스의 숨결": "Tuss's Breath", "주술의 근원": "Origin of Sorcery",
  "카프라스": "Caphras", "카라자드 반지": "Karajad Ring",
  "미확인 문양 각인서": "Unidentified Crest Book", "혼돈 문양각인": "Chaos Crest Engraving",
  "태초의 원소": "Primordial Element", "혼돈의 원소": "Chaotic Element",
  ...
  "조화의 빛": "Light of Harmony", "시간의 고리": "Ring of Time", "영겁의 고리": "Ring of Eternity",
  "영광의 증표": "Token of Glory", "돌파 복구권": "Breakthrough Recovery Ticket",
  ...
  "고결한 여신의 눈물": "Noble Tear of the Goddess",
